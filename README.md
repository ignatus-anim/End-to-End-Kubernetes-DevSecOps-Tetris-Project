...
[![GitHub](https://img.shields.io/github/stars/ignatus-anim.svg?style=social)](https://github.com/ignatus-anim)
...
1. **Clone the Repository:**
   ```bash
   git clone https://github.com/ignatus-anim/End-to-End-Kubernetes-DevSecOps-Tetris-Project.git
